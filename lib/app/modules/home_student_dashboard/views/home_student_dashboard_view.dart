      ...
      () => MainDashboardLayout(
        ...
        menuItems: [
          ...
          DashboardComponents.menuItem(
            ...
            onTap: () =>
                controller.onMenuSelected("1", Routes.HOME_STUDENT_OVERVIEW),
          ),
          ...
          _expansionMenu(
            ...
            label: "Manajemen",
            children: [
              _subMenuItem("Siswa", "2-1", Routes.HOME_STUDENT_OVERVIEW),
              _subMenuItem("Guru", "2-2", Routes.HOME_STUDENT_OVERVIEW),
              _subMenuItem("Kelas", "2-3", Routes.HOME_STUDENT_OVERVIEW),
            ],
          ),
        ...
        body: GetRouterOutlet(
          initialRoute: Routes.HOME_STUDENT_OVERVIEW,
          anchorRoute: Routes.HOME_STUDENT_DASHBOARD,
        ),
      ),
    );
  }

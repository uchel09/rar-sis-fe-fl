...
class UpdateStaffRequest {
  ...
  Map<String, dynamic> toJson() {
    ...
    if (staffPositionId != null) data['staffPositionId'] = staffPositionId;
...
class StaffResponse {
  ...
  final DateTime? hireEnd;
  final String phone;
  final StaffPositionInfo staffPosition;
  ...
  factory StaffResponse.fromJson(Map<String, dynamic> json) => StaffResponse(
    ...
    hireEnd: json["hireEnd"] != null ? DateTime.parse(json["hireEnd"]) : null,
    phone: json["phone"],
    staffPosition: StaffPositionInfo.fromJson(json["staffPosition"]),
  ...
  Map<String, dynamic> toJson() => {
    ...
    "hireDate": hireDate.toIso8601String(),
    "phone": phone,
    "staffPosition": staffPosition.toJson(),
...
class StaffPositionInfo {
  ...
  StaffPositionInfo({required this.id, required this.name});

  factory StaffPositionInfo.fromJson(Map<String, dynamic> json) =>
      StaffPositionInfo(id: json["id"], name: json["name"]);
